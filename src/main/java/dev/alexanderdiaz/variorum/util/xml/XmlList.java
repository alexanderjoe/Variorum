...
/**
 * A wrapper around {@link NodeList} that provides more convenient iteration methods and type
 * safety. Filters non-Element nodes automatically.
 */
  ...
  public Stream<Element> stream() {
    return StreamSupport.stream(
        Spliterators.spliterator(
            iterator(), nodeList.getLength(), Spliterator.ORDERED | Spliterator.SIZED),
        false);
  }

  /**
   * Gets the number of Element nodes in the list. Note: This may be less than nodeList.getLength()
   * as it only counts Element nodes.
   *
