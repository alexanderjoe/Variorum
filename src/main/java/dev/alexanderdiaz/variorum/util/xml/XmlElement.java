...
public class XmlElement {
    ...
    public boolean hasChild(String tagName) {
        ...
        for (int i = 0; i < childNodes.getLength(); i++) {
            ...
            if (node instanceof Element childElement
                    && childElement.getTagName().equals(tagName)) {
                return true;
            }
        }
        return false;
    ...
    public String getRequiredAttribute(String name) {
        return getAttribute(name)
                .orElseThrow(() -> new IllegalArgumentException("Required attribute '" + name + "' missing"));
    }
     ...
     * @return List of XmlElements representing the direct children of the first matching container element, or an empty
     *     list if no matching container is found
     */
    ...
    public XmlElement getRequiredChild(String tagName) {
        return getFirstChild(tagName)
                .orElseThrow(() -> new IllegalArgumentException("Required child '" + tagName + "' missing"));
    }
    ...
    public Optional<XmlElement> getParent() {
        ...
        return parent instanceof Element ? Optional.of(new XmlElement((Element) parent)) : Optional.empty();
    }
