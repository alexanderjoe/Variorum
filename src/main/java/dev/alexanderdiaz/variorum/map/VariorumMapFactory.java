...
public class VariorumMapFactory {
  ...
  private static VariorumMap createMapFromDocument(Document doc, MapSource source) {
    ...
    if (!"map".equals(mapElement.getTagName())) {
      throw new MapParseException(
          "Root element must be <map>", "document", getElementContext(mapElement));
    }
  ...
  private static VariorumMap.Spawns createSpawns(Document doc) {
    Element spawnsElement =
        getRequiredElement(doc, "spawns", "spawns", "Map must have spawns defined");

    try {
      return VariorumMap.Spawns.builder()
          .defaultSpawn(createSpawnRegion(getRequiredElement(
              spawnsElement, "default", "spawns", "Default spawn must be defined")))
  ...
  private static VariorumMap.Spawns.SpawnRegion createSpawnRegion(Element element) {
    try {
      ...
      return VariorumMap.Spawns.SpawnRegion.builder()
          ...
          .point(VariorumMap.Point.fromString(getRequiredElement(
                  regionsElement, "point", "spawns", "Spawn region must have a point")
              .getTextContent()))
  ...
  private static Element getRequiredElement(
      Element parent, String tagName, String section, String message) {
  ...
  private static Element getRequiredElement(
      Document doc, String tagName, String section, String message) {
