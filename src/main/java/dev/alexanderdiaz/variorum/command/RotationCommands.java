...
public class RotationCommands {
    ...
    public void rotation(
        ...
        var msg = text().append(text("Current map rotation:").color(NamedTextColor.YELLOW))
                .append(text("\n"))
    ...
    public void maps(
        ...
        var msg = text().append(text("Available maps:").color(NamedTextColor.YELLOW))
                .append(text("\n"))
                .append(text("Page ").color(NamedTextColor.YELLOW))
                .append(text(page).color(NamedTextColor.GOLD))
                .append(text(" of ").color(NamedTextColor.YELLOW))
    ...
    public void mapDetail(final CommandSender sender, final @Argument(value = "map") String mapName) {
        ...
        var msg = text().append(text("Map: ").color(NamedTextColor.YELLOW))
                .append(text(map.getName()).color(NamedTextColor.GOLD))
                .append(text("\n"))
    ...
    public void setNextMap(
        ...
        sender.sendMessage(
                text("Set next map to ", NamedTextColor.YELLOW).append(text(map.getName(), NamedTextColor.GOLD)));
    }
