...
public class FactoryUtil {
    ...
    public static <T extends Region> Optional<T> resolveRegionAs(
        ...
        if (regionId.isPresent()) {
            ...
            region = Optional.of(
                    match.getFactory().getFactory(RegionFactory.class).parseRegionAs(match, inlineRegion.get(), type));
        }
    ...
    public static <T extends Region> Optional<T> resolveRegion(
        ...
        if (!regionId.isEmpty()) {
            ...
            region = Optional.of(
                    match.getFactory().getFactory(RegionFactory.class).parseRegion(match, inlineRegion.get()));
        }
