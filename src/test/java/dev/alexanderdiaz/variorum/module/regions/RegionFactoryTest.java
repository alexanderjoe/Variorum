...
class RegionFactoryTest {
  ...
  class RegionParsingTests {
    ...
    void testParseIndividualRegionTypes() throws Exception {
      XmlElement sphereElement =
          createTestElement("sphere", Map.of("center", "0,64,0", "radius", "4"));
    ...
    void testThrowsExceptionForInvalidRegionType() {
      ...
      assertThrows(
          MapParseException.class, () -> regionFactory.parseRegion(mockMatch, invalidRegion));
    }
  }
  ...
  class EdgeCaseTests {
    ...
    void testHandlesNegativeValues() throws Exception {
      XmlElement element =
          createTestElement("sphere", Map.of("center", "-10,-20,-30", "radius", "5"));
      ...
      assertEquals(
          new Vector(-10, -20, -30), sphere.getCenter(), "Should handle negative coordinates");
    }
    ...
    void testHandlesWeirdFormattedValues() throws Exception {
      XmlElement element = createTestElement(
          "sphere", Map.of("center", " 1551   , -289,      0283  ", "radius", "5"));
      Region region = regionFactory.parseRegion(mockMatch, element);

      assertInstanceOf(SphereRegion.class, region);
      SphereRegion sphere = (SphereRegion) region;
      assertEquals(
          new Vector(1551, -289, 283), sphere.getCenter(), "Should handle negative coordinates");
    }
